/*
 * SwappablePlayer.kt
 * Implements the SwappablePlayer class
 * A implementation that delegates to an actual Player implementation that is replaceable by another instance
 *
 ...
 */
class SwappablePlayer(private var player: Player) : Player {
